...
# image de référence (préprocessée) – alignée avec SAM / depth
REF_IMAGE_PATH = PROJECT_ROOT / "Inputs" / "menphis_depay-400x225_01_preprocessed.png"

# dossiers de sortie
OUTPUTS_DIR = ZONE_SELECTION_ROOT / "outputs"
...
def main():
    ...
    # image d'affichage : upscale x3 pour le confort
    scale_factor = 3.0
